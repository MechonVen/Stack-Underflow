...
@Component({
  ...
  template: `
    <header>
      <nav>
        <div class="logo-container">
          <img
            src="https://cdn.builder.io/api/v1/image/assets%2Ff982a053b7a54180884f6ee8a9cbde51%2Feab2ab3192584e69a7af48f15fa1a5d1?format=webp&width=800"
    ...
    <footer>
      <p>
        &copy; 2025 The Zonta Club of Naples |
        <a href="https://zonta.org" target="_blank">Zonta International</a>
      </p>
    </footer>
  `,
  styles: [
